...
public class PubFlatTest {
    ...
    public void testEquals() {
        ...
        // assertTrue() is used in the following to illustrate that the methods `equals()` is being tested
        assertTrue(flatA.equals(flatB));    // assertTrue() is used here to illustrate that the methods `equals()` is being tested
    }
    ...
    public void testToString() {
        ...
        String expected = "3 rooms with base area 908, effective area 904 and living area 600\n" +
                "FS SW 2,2 4,4\n" +
                "CS ST 2,2 4,4\n" +
                "RR BA 20,50 65,70 RT 10\n" ;
