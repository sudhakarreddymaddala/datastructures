...
//
    ...
    public void calcDistanceBetween_Diagonal() {
        assertEquals((int) Math.ceil(Math.sqrt(25 + 25)),
                Analyze.calcDistanceBetween(new int[] { 1, 1 }, new int[] { 6, 6 }));
        assertEquals((int) Math.ceil(Math.sqrt(25 + 25)),
                Analyze.calcDistanceBetween(new int[] { 6, 6 }, new int[] { 1, 1 }));
        assertEquals((int) Math.ceil(Math.sqrt(25 + 64)),
                Analyze.calcDistanceBetween(new int[] { 1, 1 }, new int[] { 6, 9 }));
        assertEquals((int) Math.ceil(Math.sqrt(64 + 25)),
                Analyze.calcDistanceBetween(new int[] { 9, 6 }, new int[] { 1, 1 }));
    }
